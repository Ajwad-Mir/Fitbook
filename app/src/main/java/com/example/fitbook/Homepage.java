...
import com.example.fitbook.leaderboard.LeaderboardHome;
import com.example.fitbook.musicplayer.MusicPlayerSongList;
import com.example.fitbook.workout.WorkoutHomeListActivity;
...
public class Homepage extends AppCompatActivity {
    ...
    private Button AboutUsBtn, MusicPlayerBtn,ExerciseBtn,DietsBtn,LeaderboardBtn,RoutesBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExerciseBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Homepage.this, WorkoutHomeListActivity.class);
                startActivity(intent);
            }
        });
...
//            public void onClick(View v) {
//
//                Intent intent = new Intent(Homepage.this, RoutesHomeListActivity.class);
//                startActivity(intent);
//            }
//        });
        DietsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Homepage.this, DietsHomeListActivity.class);
                startActivity(intent);
            }
        });
        LeaderboardBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Homepage.this, LeaderboardHome.class);
                startActivity(intent);
            }
        });
    }
